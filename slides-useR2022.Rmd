...
- Introduction
  - Show #TidyFinance-approach, **Yahoo!Finance** data, portfolio choice, **efficient frontier**
- Financial data
  - **Tidy** data, Fama-French data, macroeconomic data, **WRDS** via `{RPostgres}`,  **CRSP**, **Compustat**, database and `{RSQLite}`
- Asset pricing 
  - Beta estimation, parallelization with `{future}`, **portfolio sorts**, CAPM, FF3, **Fama-MacBeth** regressions
- Modeling & machine learning
  - Factor selection, option pricing, Ridge, Lasso, random forests, neural networks, `{tidymodels}`, `{keras}`
- Portfolio optimization
  - Parametric portfolio optimization, **performance evaluation**, constrained optimization, backtesting
